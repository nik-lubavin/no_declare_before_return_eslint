...
function parseAnyStatement(node, declaredVariables, context) {
  switch (node.type) {
    ...
    case 'ReturnStatement':
      ...
      break;
    case 'ForOfStatement':
      parseForOfStatement(node, declaredVariables, context);
      break;
...
function parseForOfStatement(node, declaredVariables, context) {
  ...
  if (node.body.type === 'BlockStatement') {
    parseBlockStatement(node.body, declaredVariables, context);
  } else {
